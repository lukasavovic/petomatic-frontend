...
CREATE TABLE IF NOT EXISTS `pets` (
  ...
  `image` varchar(255) DEFAULT NULL,
  `chipped` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pet_customer1_idx` (`customers_id`),
  KEY `fk_pet_species1_idx` (`species_id`),
  KEY `fk_pets_genders1_idx` (`genders_id`),
  CONSTRAINT `fk_pet_customer1` FOREIGN KEY (`customers_id`) REFERENCES `customers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pet_species1` FOREIGN KEY (`species_id`) REFERENCES `species` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pets_genders1` FOREIGN KEY (`genders_id`) REFERENCES `genders` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `visits` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_visits_pet1_idx` (`pet_id`),
  KEY `fk_visits_customers1_idx` (`customers_id`),
  KEY `fk_visits_visitType1_idx` (`visitType_id`),
  CONSTRAINT `fk_visits_customers1` FOREIGN KEY (`customers_id`) REFERENCES `customers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_visits_pet1` FOREIGN KEY (`pet_id`) REFERENCES `pets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_visits_visitType1` FOREIGN KEY (`visitType_id`) REFERENCES `visit_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
