<template>
  <div class="Customers-wrapper">
    ...
    <div class="customer-cards" >
      <template>
        <v-flex v-for="customer in allCustomers">
          <v-card class="customer-card">
            ...
            <v-list two-line>
              ...
              <v-divider inset></v-divider>
              <template>
                <div v-for="pet in allPets" v-if="customerHasPet(pet.customers_id, customer.id)" :key="pet.id">
                 <div class="singlePet">
...
<script>
  ...
  export default {
    ...
    this.axios
      .get('http://localhost:3005/app/pets')
      .then( (response) => {
        console.log(response.data);
